...
import {RMRKTokenAttributesRepository} from
    "@rmrk-team/evm-contracts/contracts/RMRK/extension/tokenAttributes/RMRKTokenAttributesRepository.sol";
import {RMRKEmotesRepository} from "@rmrk-team/evm-contracts/contracts/RMRK/emotable/RMRKEmotesRepository.sol";

// Mock RMRK Registry to expose addExternalCollection function.
contract MockRMRKRegistry {
    function addExternalCollection(address collection, string memory collectionMetadata) external {}
}
